...
* Date: Tue Oct 20 13:45:35 2020
* Arguments:
* "-B""macro_default""-W""dotnet:PlotFigure,Class1,4.0,private,version=1.0""-T""link:lib""
* -d""\\Mac\Home\Dropbox
* (Personal)\Work\Git_Repo\netAssemblies-matlab\plotFigureUsingClass\PlotFigure\for_testin
    ...
    static Class1()
    {
      if (MWMCR.MCRAppInitialized)
      {
        try
        {
          ...
          string ctfFileName = "PlotFigure.ctf";
