PlotStateSpaceComp MATLAB .NET Assembly (.NET Component)
...
-PlotStateSpaceComp.dll
   -contains the generated component using MWArray API. 
-PlotStateSpaceCompNative.dll
...
PlotStateSpaceComp_overview.html - HTML overview documentation file for the generated 
...
PlotStateSpaceComp.xml - This file contains the code comments for the PlotStateSpaceComp 
                                   component classes and methods. Using a third party 
                                   documentation tool, this file can be combined with 
                                   either or both of the previous files to generate 
                                   online documentation for the PlotStateSpaceComp 
                                   component.
